...
export const ProductCard: FC<ProductCardProps> = ({ batch }) => {
  ...
  console.log("IMG: ", process.env.NEXT_PUBLIC_IMG_BASE_URL, product.img);

  return (
    <div className={style.productCard}>
      <Image
        src={`${process.env.NEXT_PUBLIC_IMG_BASE_URL}${product.img}`}
      ...
      <div>
        ...
        <div className={style.productActions}>
          <div className={style.stepper}>
            <p className={style.button} onClick={handleAddItemToCart}>
              -
            </p>
            <input
              type='number'
